...
<html lang="en">
  ...
  <body>
    <div class="jumbotron text-center">
        <h1>RECTEM Student Records Handling Database</h1>
    </div>
    <div class="container">
        <div class="row text-center" >
            <div class="col-md-6">
              <h2 class="display-2">Staff</h2>
                <div class="text-center col-12">
                    <img src="image/TeacherStudents.jpg" width="300" height="150" class="responsive" alt="Students">
                </div>
              <div class="form-row">
                  ...
                  <div class="modal-content">
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button data-dismiss="modal" type="button" class="btn btn-outline-danger">Cancel</button>
                        </div>
                    </form>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <h2 class="display-2">Student</h2>
                <div class="text-center col-12">
                    <img src="image/Students1.jpg"  width="309"  class="responsive" alt="Students">
                </div>
              <div class="form-row">
                <div class="form-group col">
