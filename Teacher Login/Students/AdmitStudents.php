                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="inputState" name="section" <?php if(!$sec){ ?> class="form-control" <?php } else {  ?> class="custom-select is-invalid" <?php unset($_SESSION['section']);} ?>>
                                                ...
                                                <option value="B">Laboratory Science</option>
                                                <option value="B">Computer Engineering</option>
                                                <option value="B">Business Administration</option>
                                                <option value="B">Laboratory Science</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="AdmissionDate">Admission Year</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="Nationality" class="form-control" id="Nation" required>
                                        </div>
                                    </div>
                                ...
                                <hr  class="my-4">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="FatherPhoneNum" <?php if(true){ ?> class="form-control" <?php } else { ?> class="custom-select is-invalid" <?php } ?> id="FatherPhNum" value="+234 ">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="MotherPhoneNum" class="form-control" id="MotherPhNum" value="+234 ">
                                        </div>
                                    </div>
                                    <div class="form-row">
